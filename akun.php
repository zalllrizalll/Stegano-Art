...
<body>
    ...
    <main class="d-flex flex-nowrap">
        <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item">
                    <a href="#" class="nav-link text-white" aria-current="page" id="homeLink" onclick="showSection('homeSection')">
                ...
                <li>
                    <a href="#" class="nav-link text-white" id="galeriFotoLink" onclick="showSection('galeriFotoSection')">
                        <svg class="bi pe-none me-2" width="16" height="16">
        ...
        <!-- Galeri Foto Content -->
        <div class="container" id="galeriFotoSection" style="display:none; overflow-y: auto; max-height: 1600px;">
            <div class="row align-items-center mt-2">
                <h3 class="fs-2 mt-2">List</h3>
    ...
    <script>
        ...
        function showSection(sectionId) {
            ...
            document.getElementById('galeriFotoSection').style.display = 'none';
    ...
    <script>
        ...
        document.getElementById('galeriFotoLink').addEventListener('click', function() {
